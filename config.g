...
;; external Trigger
M581 P"e0stop" T3 C0					;Trigger 3 auf Endstop E0 		(Move Up 50mm)
M581 P"^duex.e2stop" T4 C0				;Trigger 4 auf duex2endstop 	(Move Down 50mm)
M581 P"e1stop" T5 C0					;Trigger 5 auf Endstop E1		(Heated Bed On/Off)
M581 P"^duex.e3stop" T8 C0				;Trigger 8 aud duex3endstop		(G28)
M581 P"^duex.e4stop" T9 C0				;Trigger 9 auf duex4endstop		(G32)
